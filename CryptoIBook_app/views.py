...
from CryptoIBook_app.models import UserRegistration,  UserLogin, Addproduct, Addpayment, AddCategory, MyOrder,OtpCode,,


from django.core.files.storage import FileSystemStorage
import os
from CryptoIBook.settings import BASE_DIR
import random
import smtplib
import datetime
...
def Addproduct(request):
    ...
    if request.method == 'POST' and request.FILES['myfile']:
        ...
        return render(request, 'BlcokChain.html', {'msg': 'Thank you for adding product','udict':udict})
    return render(request, 'BlockChain.html',{'udict':udict})


def Crypto_coins(request):
        return render(request, 'Crypto_coins.html'),
...
def product_edit(request, pk):
    ...
    if request.method == 'POST' and request.FILES['myfile']:
        ...
        base_url=reverse('BlockChain_view')
        return redirect(base_url)
